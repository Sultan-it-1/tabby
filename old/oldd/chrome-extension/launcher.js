...
document.addEventListener("DOMContentLoaded", () => {
  ...
  btnLaunch.addEventListener("click", async () => {
    ...
    try {
      ...
      // Create and Configure the Iframe pointing to Company Apps Script Web App
      const iframe = pipWindow.document.createElement("iframe");
      const companyAppUrl = localStorage.getItem('fastToolkitCompanyWebAppUrl') || "https://script.google.com";
      iframe.src = companyAppUrl;
